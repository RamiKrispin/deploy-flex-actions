#' Creating GIS mapping
#' @description  Loading GIS country to UID/ISO/FIPS codes mapping from John Hopkins COVID19 tracker and Data Hub
#' @source https://github.com/CSSEGISandData/COVID-19
#' @source https://datahub.io/core/continent-codes
...
save(continent_mapping, gis_code_mapping, gis_codes_coronavirues, file = "./data/gis_mapping.RData")
